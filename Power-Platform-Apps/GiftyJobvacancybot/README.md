...
## Solution Overview
This Solution is developed to enable staffs of an organization to check available job vacancies in the organizatio by simply chatting with a bot called Gifted.
